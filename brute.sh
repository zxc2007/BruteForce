...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" RekiXploit  [OneTXz]"$i"          |"
echo $i" |"$pu" Instagram :"$ku" RekiXploit"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR X Two] [PROFESOR21] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%Mr.OneTXz%] [RekiXploit]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 089508902582"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" mronetxz@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"RekiXploit"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 089508902582"
echo $ku"Instagram :"$i" RekiXploit"
sleep 2
